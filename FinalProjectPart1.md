...
## Method & Medium
I will be using Shorthand and relying on bold callouts, interactive maps, and embedded images to tell this story. The story will rely on scrolling and honing on certain elements to help the reader understand the visualizations. For example, for maps, it may be easy for the reader to see the hot spots, but highlighting a particular neighborhod and providing more background could be helpful. Additionally, the story will progress in a linear fashion and go from big-picture definitons to specific examples of effects of gentrification.

The story will conclude with a few call-to-actions. The first will focus on supporting local businesses and linking to a website that allows them to do that; the second will allow to advocate for fair housing policies and see bills/online petitions; the third will allow them to connect with local representatives; and the last will focus on registering to vote in the upcoming local elections. 
